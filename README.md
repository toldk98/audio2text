...
**Інтерфейс**
- **GUI** — графічний інтерфейс (ttkbootstrap) з підтримкою 2 мов (UK/EN)
- **CLI** — командний рядок
...
Інтерфейс підтримує українську та англійську мови.
Перемикання: **Налаштування → Загальні → Мова**.
Перезапустіть програму після зміни.
